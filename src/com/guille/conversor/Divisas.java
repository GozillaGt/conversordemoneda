package com.guille.conversor;

import com.guille.app.MensajeFinal;
import javax.swing.ImageIcon;
import javax.swing.JOptionPane;

public class Divisas {
    // Carga los íconos para mostrar en el cuadro de diálogo
    ImageIcon icon = new ImageIcon(getClass().getResource("/com/guille/icons/icon-divisa.png"));
    ImageIcon iconM = new ImageIcon(getClass().getResource("/com/guille/icons/icon-error.png"));

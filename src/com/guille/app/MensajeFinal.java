...
public class MensajeFinal {
    ...
    ImageIcon iconP = new ImageIcon(getClass().getResource("/com/orliluq/icons/icon-question.png"));
    ImageIcon iconE = new ImageIcon(getClass().getResource("/com/orliluq/icons/icon-salir.png"));
